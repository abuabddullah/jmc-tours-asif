// define metadata with robots
export const metadata = {
  title: {
    absolute: "Dashboard",
  },
  description: "Dashboard for JMC tours",
  robots: {
    index: false, // will not show in search engine
    follow: true, // will show in search engine
  },
};
  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <h1 className="text-base leading-8">
          Welcome to <br />{" "}
          <span className="uppercase text-4xl lg:text-5xl text-black">
            Dashboard
          </span>
        </h1>
