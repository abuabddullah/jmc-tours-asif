  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <div
        ...
        className="  text-base text-gray-600 bg-transparent  rounded-md  flex gap-1 items-center hover:text-green-400 border-b-2 border-transparent hover:border-[#DD7364] relative z-10 lg:px-3 lg:pb-2  mt-2"
      >
