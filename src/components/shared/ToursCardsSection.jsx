...
//   const { wishedItems, toggleWishItem } = useWishList(); // Use the custom hook
...
//         <div
//           key={index}
//           className="relative7777 bg-white rounded-xl shadow-lg overflow-hidden"
//           data-aos="fade-up"
//           data-aos-delay={index * 100}
//           data-aos-duration="1000"
//         >
//           <div className="relative777 h-[28rem] w-full">
//             <Image
...
//                 <button
//                   className={`${
//                     wishedItems?.includes(tour)
//                       ? "text-red-500"
//                       : "text-gray-900"
//                   } bg-white bg-opacity-50 shadow rounded  p-1`}
