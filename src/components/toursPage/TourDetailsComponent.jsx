          ...
          <div className="lg:container flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold">
                {tour?.title}, <br /> {tour?.country || "Bangladesh"}
              </h1>
            ...
            <div className="flex flex-col md:flex-row items-center md:space-x-6 space-y-3 md:space-y-0 mt-4 lg:mt-0 lg:border-none border-t border-gray-300 lg:pt-0 pt-6 w-full lg:w-auto">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-col flex">
                  ...
                  <span>${tour?.cheapPriceFrom?.toFixed(2) || 1700}</span>
                </div>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="capitalize flex items-center gap-3">
                ...
                <span className="text-gray-500">{tour?.tourType || "Honeymoon"} tour</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:flex justify-between lg:gap-4 my-12 lg:container p-8">
          <div className="lg:w-2/3">
            <div className="bg-white p-6 rounded-lg mb-8">
              ...
              <p className="text-gray-500">{tour?.overview || `Embark on an unforgettable journey with our all-inclusive tour package, perfect for adventure seekers and leisure travelers alike. Explore stunning landscapes, immerse yourself in rich cultures, and enjoy comfortable accommodations and guided experiences, all designed to create lasting memories on your next getaway.
`}</p>
            </div>
            ...
            {/* Tour Plan Accordion */}
            <LocationPacakgePageAccordion />

            <div className="p-6">
              <h3 className="text-xl font-bold mb-4">Related Tours</h3>
              <CategoryBasedPackagesPage packageType={tour?.category || "popular"} />
            </div>
          </div>
          ...
          <aside>
            ...
            <div className="bg-white p-6 rounded-2xl border lg:mt-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Link href={`/package-booking/${tour?.id}/${tour?.title}`}>
